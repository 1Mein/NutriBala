...
const itemExps = [
    {
        ...
        'Exps': [{
            ...
            'id': '1',
            'title': 'Желудок',
            'content': 'Резервуар верхнего отдела пищеварительного ' +
                'asdfasdf' +
                '' +
                'тракта, образованный из гладкой мышечной ткани, в котором происходит частичное расщепление и разжижение пищи и регулярное ее продвижение в подходящих объемах (порциями) в тонкую кишку.'
        }]
    },
    {
        'forId': '1',
        ...
        <div class=" mt-10">
            ...
            <div v-if="currentItem" id="accordion">
                <a @click="currentItem=null"
                   class="lg:ms-[150px]  cursor-pointer underline text-[20px] font-semibold text-designColor1">←
                    Назад</a><br>
                <div class="lg:mx-[200px] mt-[20px]">
                    ...
                    <div v-for="itemExp in itemExps[currentItem]['Exps']" class="border-b border-slate-200">
                        ...
                        <div :id="'content-'+itemExp['id']"
                             class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                            <div class="pb-5 text-sm text-slate-500">
                                <span v-html="itemExp['content']"></span>
                            </div>
                        </div>
                    </div>
                </div>
